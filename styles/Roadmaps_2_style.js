...
var style_Roadmaps_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if ("" !== null) {
        ...
        function rules_Roadmaps_2(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_Roadmaps_2rule3_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        var style = rules_Roadmaps_2(feature, value);
        ;
